...
def main(page: ft.Page):
    ...
    page.add(
        ft.Container(content=info, alignment=ft.Alignment.CENTER, padding=20), # vanhemmissa versioissa ft.alignment.center
    )

ft.run(main) # vanhemmissa versioissa ft.app(target=main)