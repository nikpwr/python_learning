...
################################################################################
## Form generated from reading UI file 'RGBWidgetVvSsVq.ui'
##
...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.label_1.setStyleSheet(u"background:red;color:white;font-weight:bold;")
        ...
        self.verticalLayout_1.addWidget(self.spinBox_1)
        ...
        self.verticalSlider_1.setTickPosition(QSlider.TickPosition.NoTicks)

        self.verticalLayout_1.addWidget(self.verticalSlider_1, 0, Qt.AlignmentFlag.AlignHCenter)
        ...
        self.label_2.setStyleSheet(u"background:green;color:white;font-weight:bold;")
        ...
        self.verticalSlider_2.setTickPosition(QSlider.TickPosition.NoTicks)
        ...
        self.label_3.setStyleSheet(u"background:blue;color:white;font-weight:bold;")
        ...
        self.verticalSlider_3.setTickPosition(QSlider.TickPosition.NoTicks)
